...
/* Tests public methods of PngImageReaderSpi
 */
public class Test_PngImageReaderSpi extends TestCase {

	/* Fixture instance variables needed for the test cases */
	PngImageReaderSpi pngSpi;
	...
	public static Test suite() {
		return new TestSuite(Test_PngImageReaderSpi.class);
	}

	/* Constructor */
	public Test_PngImageReaderSpi(String name) {
		super(name);
	}

	/* Code to set up test scaffold for each test */
	protected void setUp() {
		pngSpi = new PngImageReaderSpi();
	}
	...
	static final String [] images = {
		...
		"basi4a16.png", "basi6a08.png", "basi6a16.png", "basn0g01.png",
		"basn0g02.png", "basn0g04.png", "basn0g08.png", "basn0g16.png",
		"basn2c08.png", "basn2c16.png", "basn3p01.png", "basn3p02.png",
		"basn3p04.png", "basn3p08.png", "basn4a08.png", "basn4a16.png",
		"basn6a08.png", "basn6a16.png", "bgai4a08.png", "bgai4a16.png",
		"bgan6a08.png", "bgan6a16.png", "bgbn4a08.png", "bggn4a16.png",
		"bgwn6a08.png", "bgyn6a16.png", "ccwn2c08.png", "ccwn3p08.png",
		"cdfn2c08.png", "cdhn2c08.png", "cdsn2c08.png", "cdun2c08.png",
		"ch1n3p04.png", "ch2n3p08.png", "cm0n0g04.png", "cm7n0g04.png",
		"cm9n0g04.png", "cs3n2c16.png", "cs3n3p08.png", "cs5n2c08.png",
		"cs5n3p08.png", "cs8n2c08.png", "cs8n3p08.png", "ct0n0g04.png",
		"ct1n0g04.png", "ctzn0g04.png", "f00n0g08.png", "f00n2c08.png",
		"f01n0g08.png", "f01n2c08.png", "f02n0g08.png", "f02n2c08.png",
		...
		"tbbn1g04.png", "tbbn2c16.png", "tbbn3p08.png", "tbgn2c16.png",
		"tbgn3p08.png", "tbrn2c08.png", "tbwn1g16.png", "tbwn3p08.png",
		"tbyn3p08.png", "tp0n1g08.png", "tp0n2c08.png", "tp0n3p08.png",
		"tp1n3p08.png", "z00n2c08.png", "z03n2c08.png", "z06n2c08.png",
		"z09n2c08.png"
	};

	public void testCanDecodeInputImageInputStream_allPngImages() 
	throws Exception
	{
		String dir = Test_PngImageReader.dir; 

		for (int i=0; i<images.length; i++) {
			String fileName = dir + images[i];
			Assert.assertTrue(pngSpi.canDecodeInput(new
						FileImageInputStream(new File(dir+images[i]))));
		}
	}
}
