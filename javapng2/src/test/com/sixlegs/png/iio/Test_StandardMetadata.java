...
public class Test_StandardMetadata extends TestCase {
	static final String dir = "images/suite/";
	static final String logFile = "iiometadata_standard";
	...
	public static Test suite() {
		return new TestSuite(Test_StandardMetadata.class);
	}

	/* Constructor */
	public Test_StandardMetadata(String name) 
	throws Exception
	{
		super(name);
	...
	throws Exception
	{
		...
		Node n = iiom.getAsTree(IIOMetadataFormatImpl.standardMetadataFormatName);
		displayMetadata(n);
		out.println("                                                  ");
	}
