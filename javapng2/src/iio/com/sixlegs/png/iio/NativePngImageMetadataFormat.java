...
public class NativePngImageMetadataFormat 
extends IIOMetadataFormatImpl 
{
	...
	// singleton
	private static NativePngImageMetadataFormat defaultInstance =
		new NativePngImageMetadataFormat();

	// Make constructor private to enforce the singleton pattern
	private NativePngImageMetadataFormat() 
	{
	...
	public static NativePngImageMetadataFormat getDefaultInstance() 
	{
